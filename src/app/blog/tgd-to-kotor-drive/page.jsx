...
const DESC = "A driving guide from Podgorica Airport to Kotor: the Sozina tunnel, the Budva bypass, the Vrmac ridge descent, and where to park at the Old Town.";
