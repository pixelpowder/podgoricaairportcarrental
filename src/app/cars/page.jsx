...
export async function generateMetadata() {
  const title = 'Our Fleet — 7 Cars for Multi-Day Kotor Rentals | Kotor Car Rental';
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${SITE}/cars`,
      type: 'website',
      images: [{ url: `${SITE}/img/fleet/renault-megane.jpg`, width: 1200, height: 800, alt: 'Kotor Car Rental fleet' }],
    },
  };
}
